...
const MainLayout: React.FC = () => {
  ...
  return (
    <div className={`h-screen flex flex-col bg-gray-100 ${isResizing ? 'cursor-col-resize select-none' : ''}`}>
      <Toolbar />
                 ...
                 return (
                   <div key={sectionId} className="border-b border-gray-100 last:border-0">
                     <div
                        onClick={() => toggleSection(sectionId)}
                        className={`w-full flex items-center justify-between p-4 transition-colors cursor-pointer ${
                           isOpen ? 'bg-blue-50 text-blue-700 sticky top-0 z-10 border-b border-blue-100 shadow-sm' : 'bg-white text-gray-700 hover:bg-gray-50'
                        }`}
                     >
